...
mod tests {
    ...
    #[test]
    fn perft_pos3() {
        let mut gs = BitBoardGame::from_fen("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -").unwrap();
    ...
    fn perft_pos5() {
        let mut gs =
            BitBoardGame::from_fen("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8")
                .unwrap();
